...
## Technical Expertise
⚡ Electronic Hardware Development Lifecycle Management and Architecture⚡ Schematic Design, PCB Layout, Design Review & Manufacturability Considerations (DFM/DFT)⚡ Analog and Digital, Signal Conditioning, and Filter Circuit Design⚡ Power Electronics (Buck, Boost, MPPT, Battery Charging Systems)⚡ MOSFET-based Power Stages, Transient Protection, Voltage and Current Sensing Circuit⚡ Hardware Verification and Validation, Test Plan, Test Procedure and Test Report Preparation⚡ Microprocessor/Microcontroller and Embedded Hardware (STM32, ESP32, AVR)⚡ Hardware–Firmware Integration, Simulation, Prototype Assembly, Soldering, Rework & Debugging⚡ EMC / EMI aware hardware design  
...
in a single platform using a same components. The system operates as a solar MPPT buck charger 
during daytime and transitions to a battery-powered LED driver at night.
...
into adjustable output levels from 12 V to 72 V. The system uses a synchronous buck topology 
for efficient power conversion and supports industrial-grade current sensing up to 28 A, making 
...
integrating sensor acquisition, actuator control, charging controller interfacing, and real-time 
HMI display. Built around a 32-bit microcontroller, the system manages multiple analog and 
digital inputs while coordinating motor control, indicator outputs, and system monitoring 
functions. 
